...
user-not-found = Пользователь не найден. Сначала отправьте /start.
shop-not-implemented = Магазин пока не реализован.
shop-choose-category = Выберите категорию:
...
top-up-invalid-amount = Введите корректную сумму без точек и запятых, только целое число.
top-up-amount-positive = Введите сумму больше 0.
top-up-success = Баланс пополнен: { $balance }

payment-method-cryptobot = CryptoBot комиссия 1.5%
payment-method-xrocket = XRocket комиссия 1%
