...
class UserManager(BaseManager):
    async def get_locale(self, event_from_user: TgUser, db_user: Optional[DbUser] = None) -> str:
        """
    ...
    async def set_locale(self, locale: str, event_from_user: TgUser, db_user: Optional[DbUser], session: AsyncSession) -> None:
        """
